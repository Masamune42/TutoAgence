            ...
            <div class="col vstack gap-3" style="flex: 25">
                @foreach ($property->pictures as $picture)
                 <div id="picture{{ $picture->id }}" class="position-relative">
                    ...
                    <button class="btn btn-danger position-absolute bottom-0 w-100 start-0" type="button" hx-delete="{{ route('admin.picture.destroy', $picture->id) }}" hx-target="#picture{{ $picture->id }}" hx-swap="delete">
